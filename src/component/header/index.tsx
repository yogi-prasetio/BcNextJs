...
const navRedux = [
  { name: "Product", href: "/reduxproduct", current: false },
  { name: "Category", href: "/reduxcategory", current: false },
  { name: "Customer", href: "/reduxcustomer", current: false },
  { name: "Order", href: "/reduxorder", current: false },
  { name: "Order Detail", href: "/reduxorderdetail", current: false },
];
